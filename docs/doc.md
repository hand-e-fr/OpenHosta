...
- [Documentation](#documentation)
  ...
  - [Control un certainty with safe context](#control-un-certainty-with-safe-context)
...
## Control un certainty with safe context

When using LLMs, it's common to encounter situations where the model may produce uncertain or ambiguous responses. To address this, OpenHosta provides a feature called "safe context" that allows you to define specific conditions under which the model should respond with a default value (e.g., `None`) instead of attempting to provide an uncertain answer.
