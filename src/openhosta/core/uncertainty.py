...
from ..core.errors import ModelMissingLogprobsError, UncertaintyError
...
def posterior_probability(prediction, possible_outcomes, prior_prob_list:dict[str,float] = None, previouse_string = "") -> dict:

    # Fill prior_prob_list with uniform distribution if empty
    if prior_prob_list is None:
        prior_prob_list = {}
