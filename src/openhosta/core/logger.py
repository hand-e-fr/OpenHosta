...
def _get_inspection(target: Any) -> Inspection | None:
...
def print_last_prompt(target: Callable | Any):
    """
...
def print_last_decoding(target: Callable | Any):
    """
...
def print_last_probability_distribution(target: Callable | Any):
    """
...
def print_last_uncertainty(target: Callable | Any):
    """
