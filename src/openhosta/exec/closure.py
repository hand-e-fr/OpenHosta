...
from ..core.inspection import Inspection, get_hosta_inspection
...
def closure_async(
    query_string,
    *,
    pipeline: OneTurnConversationPipeline | None = config.DefaultPipeline,
    force_return_type: object | None = None,
    force_llm_args: dict | None = None
    ):

    if force_llm_args is None:
        force_llm_args = {}
    ...
    async def inner_func(*args, **kwargs) -> Any:
        ...
        inner_func_pointer.hosta_inspection = inspection
