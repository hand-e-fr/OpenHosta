...
async def gather_data_async(data: dict | list, batch_size: int = 30, max_delay: int | None = 120):
...
def gather_data(data: dict | list, batch_size: int = 30, max_delay: int | None = 120):
    """
