...
ideas = [
    """il y a une ile avec une ancienne mine""",
    """il y a une guerre des mafias qui se partagent la ville""",
    """il y a des des sous-terrains habités par des mutants""",
    """ce monde à été ravagé par une guerre mondiale""",
    """les mutations sont causées par une maladie"""
    ]
